...
AR_STATIC_ARGS = cr
NAME = File::Binary
DISTNAME = File-Binary
NAME_SYM = File_Binary
VERSION = 0.2
VERSION_SYM = 0_2
XS_VERSION = 0.2
INST_BIN = blib/bin
...
TO_INST_PM = Binary.pm

PM_TO_BLIB = Binary.pm \
	$(INST_LIBDIR)/Binary.pm
...
manifypods : pure_all Binary.pm
	@$(POD2MAN) \
	Binary.pm \
	$(INST_MAN3DIR)/File::Binary.$(MAN3EXT)
